...
SceneRenderer::SceneRenderer(const int& width, const int& height)
{
    ...
    m_Water.AttachShader(VERTEX, "shaders/wave.vert");
    m_Water.AttachShader(FRAGMENT, "shaders/wave.frag");
    m_Water.LinkProgram();
    ...
    m_Receiver.AttachShader(VERTEX, "shaders/receiver.vert");
    m_Receiver.AttachShader(FRAGMENT, "shaders/receiver.frag");
    m_Receiver.LinkProgram();
    ...
    //refractions / reflections
    {
        ...
        }
        {
            m_Refractions.Bind();
                ...
                m_Receiver.SetFloat("attenuation", state.m_Attenuation);
                m_Receiver.SetFloat("firstStage", state.m_FirstStage);
                m_Receiver.SetFloat("secondStage", state.m_SecondStage);
        ...
        m_Water.Use();
            ...
            m_Water.SetVec3("firstStageColor", state.m_FirstStageColor);
            state.m_HeightField.Bind(GL_TEXTURE0);
